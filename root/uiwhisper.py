...
class WhisperDialog(ui.ScriptWindow):
	...
	def LoadDialog(self):
		...
		self.AddFriendButton.SetEvent(ui.__mem_func__(self.AddFriend))
	...
	def SetWhisperDialogSize(self, width, height):
		try:
			...
			if localeInfo.IsARABIC():
				...
				self.AddFriendButton.SetPosition(width-70+self.minimizeButton.GetWidth(), 10)
				...
				self.AddFriendButton.SetPosition(width-70, 10)
