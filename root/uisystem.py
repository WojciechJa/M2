...
class SystemDialog(ui.ScriptWindow):
	...
	def __LoadSystemMenu_Default(self):
		...
		self.GetChild("option_button").SAFE_SetEvent(self.__ClickOptionButton)
		...
		self.GetChild("klawisze_button").SAFE_SetEvent(self.__ClickHelpButton)
