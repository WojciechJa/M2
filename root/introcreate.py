...
class CreateCharacterWindow(ui.Window):
	...
	class CharacterRenderer(ui.Window):
		def OnRender(self):
			...
			grp.SetPerspective(14.0, newScreenWidth/newScreenHeight, 1000.0, 3000.0)
	...
	def Open(self):
		...
		try:
			...
			pythonScriptLoader.LoadScriptFile(dlgBoard, "arezzo/ui/createcharacterwindow.py")
		...
		try:
			...
			self.editCharacterName = getChild("name_value")

			self.genderButton = []
			self.genderButton.append(getChild("man"))
			self.genderButton.append(getChild("woman"))
			
			self.char = []
			self.char.append(getChild("char0"))
	...
	def CreateCharacter(self):
		...
		for eachSlot in xrange(SLOT_COUNT):
			chr.SelectInstance(self.__GetSlotChrID(self.gender, eachSlot))
