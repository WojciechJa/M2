	...
	class ExpandedMoneyTaskBar(ui.ScriptWindow):
		...
		def LoadWindow(self):
			try:
				...
				self.tt[2].SetTitle("Punkty osi¹gniêæ")
				...
				self.tt[3].AppendTextLine("Wciœnij {}".format(emoji.AppendEmoji("icon/emoji/key_lclick.tga"))+", aby kupiæ.")
				...
				self.tt[4].AppendTextLine("Wciœnij {}".format(emoji.AppendEmoji("icon/emoji/key_lclick.tga"))+", aby sprzedaæ.")
