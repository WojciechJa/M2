...
class AttachMetinDialog(ui.ScriptWindow):
	...
	def __LoadScript(self):
		...
		try:
			...
			self.MetinSlot = self.GetChild("MetinSlot")

			self.AttachMetinArrow = self.GetChild("AttachMetinArrow")
		...
		newToolTip.SetPosition(300, 38)
		newToolTip.SetModelShow(False)
	...
	def UpdateDialog(self):
		newWidth = self.oldToolTip.GetWidth() + self.newToolTip.GetWidth() + 70
		newHeight = self.newToolTip.GetHeight() + 98

		self.newToolTip.SetPosition(self.oldToolTip.GetWidth() + 60, 38)
		self.AttachMetinArrow.SetPosition(self.oldToolTip.GetWidth()+28, self.oldToolTip.GetHeight()/2)
		self.MetinSlot.SetPosition(self.oldToolTip.GetWidth()+20, self.oldToolTip.GetHeight()/2 + 40)
