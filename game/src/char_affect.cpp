...
#define IS_NO_CLEAR_ON_DEATH_AFFECT(type) ((type) == AFFECT_BLOCK_CHAT || ((type) >= 500 && (type) < 600) || (type >= AFFECT_COLLECTIONS0 && type <= AFFECT_COLLECT_KOLEKCJONER_EXTRA) || (type >= 740 && type <= 749) || (type >= 900 && type <= 903) || (type == 750))
