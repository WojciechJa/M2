...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_PRIVATE_SHOP, sizeof(TPacketCGPrivateShop), "PrivateShop");
#endif
#ifdef ENABLE_LRN_BATTLE_PASS
	Set(HEADER_CG_BATTLE_PASS_COLLECT, sizeof(TPacketBattlePassCollect), "BattlePassCollect");
#endif
#if defined(__DUNGEON_INFO_SYSTEM__)
	Set(DungeonInfo::Packet::HEADER_CG_DUNGEON_INFO, sizeof(DungeonInfo::Packet::CGInfo), "DungeonInfo", true);
#endif
#ifdef __REMOVE_ITEM__
	Set(HEADER_CG_REMOVE_ITEM, sizeof(TPacketCGRemoveItem), "RemoveItem", true);
#endif
	...
	Set(HEADER_CG_ODLAMKI_ITEM, sizeof(TPacketCGOdlamki), "OdlamkiItem", true);
#endif
#ifdef ENABLE_VS_SHOP_SEARCH
	Set(HEADER_CG_SEARCH, sizeof(TPacketCGSearch), "SearchItemList", true);
#endif
#ifdef ENABLE_SWITCHBOT
	Set(HEADER_CG_SWITCHBOT, sizeof(TPacketGCSwitchbot), "Switchbot", true);
#endif
#ifdef WEEKLY_RANK_BYLUZER
	Set(HEADER_CG_WEEKLY_RANK, sizeof(TPacketCGSelectWeeklyRank), "SelectWeeklyRank", true);
#endif
#ifdef TITLE_SYSTEM_BYLUZER
	Set(HEADER_CG_TITLE_ACTIVE, sizeof(TPacketCGTitleActive), "TitleActive", true);
#endif
	...
	Set(HEADER_CG_SEND_LOCATION_MANAGER, sizeof(TPacketCGSendLocationManager), "PlayerLocationManager", true);
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
	Set(HEADER_CG_ACCE, sizeof(TPacketAcce), "Acce", true);
#endif
#ifdef ENABLE_AURA_SYSTEM
	Set(HEADER_CG_AURA, sizeof(TPacketAura), "Aura");
#endif
#ifdef ENABLE_DROP_INFO
	Set(HEADER_CG_DROP_INFO, sizeof(BYTE), "DropInfo", true);
#endif
#ifdef __ITEM_SHOP__
	Set(HEADER_CG_ITEMSHOP, sizeof(TItemShopCGPacket), "ItemShop", true);
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
	Set(HEADER_CG_PET_ACTION, sizeof(TPacketPetAction), "RecivePetAction", true);
#endif
#ifdef __TOMBOLA__
	Set(HEADER_CG_TOMBOLA, sizeof(TPacketCGTombola), "Tombola", true);
#endif
...
#endif
	// Set(HEADER_CG_MOUNT_NPC_ACTION, sizeof(TPacketCGMountNPCAction), "ReciveMountNPCAction", true);
	...
	Set(HEADER_CG_INGOT_OPEN, sizeof(TPacketCGOpenIngot), "ingot_open", false);
#endif
	Set(HEADER_CG_GIVE_ITEMS, sizeof(TPacketCGGiveItems), "give_items", true);
}
...
#endif
#ifdef __PREMIUM_PRIVATE_SHOP__
	Set(HEADER_GG_PRIVATE_SHOP_ITEM_SEARCH_UPDATE, sizeof(TPacketGGPrivateShopItemSearchUpdate), "PrivateShopItemSearchUpdate");
	Set(HEADER_GG_PRIVATE_SHOP_ITEM_SEARCH, sizeof(TPacketGGPrivateShopItemSearch), "PrivateShopItemSearch");
	Set(HEADER_GG_PRIVATE_SHOP_ITEM_SEARCH_RESULT, sizeof(TPacketGGPrivateShopItemSearchResult), "PrivateShopItemSearchResult");
#endif

    Set(HEADER_GG_RELOAD, sizeof(TPacketGGReload), "Reload");
}
