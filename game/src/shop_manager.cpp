...
LPSHOP CShopManager::CreatePCShop(LPCHARACTER ch, TShopItemTable* pTable, int bItemCount)
#else
...
#ifdef __EXTENDED_ITEM_COUNT__
void CShopManager::Sell(LPCHARACTER ch, WORD wCell, int bCount, BYTE bType)
#else
