...
void initTrade()
{
	VMProtectBeginUltra("initTrade");
	static PyMethodDef s_methods[] =
	{
		 { VMProtectDecryptStringA("InitTrading"),					exchangeInitTrading,				METH_VARARGS},
		 { VMProtectDecryptStringA("isTrading"),					exchangeisTrading,					METH_VARARGS},

		 { VMProtectDecryptStringA("GetElkFromSelf"),				exchangeGetElkFromSelf,				METH_VARARGS},
		 { VMProtectDecryptStringA("GetElkFromTarget"),			exchangeGetElkFromTarget,			METH_VARARGS},

#ifdef ENABLE_CHEQUE_SYSTEM
		 { VMProtectDecryptStringA("GetChequeFromSelf"),			exchangeGetChequeFromSelf,			METH_VARARGS},
		 { VMProtectDecryptStringA("GetChequeFromTarget"),			exchangeGetChequeFromTarget,		METH_VARARGS},
#endif

		 { VMProtectDecryptStringA("GetItemVnumFromSelf"),			exchangeGetItemVnumFromSelf,		METH_VARARGS},
		 { VMProtectDecryptStringA("GetItemVnumFromTarget"),		exchangeGetItemVnumFromTarget,		METH_VARARGS},

		 { VMProtectDecryptStringA("GetItemCountFromSelf"),		exchangeGetItemCountFromSelf,		METH_VARARGS},
		 { VMProtectDecryptStringA("GetItemCountFromTarget"),		exchangeGetItemCountFromTarget,		METH_VARARGS},

		 { VMProtectDecryptStringA("GetAcceptFromSelf"),			exchangeGetAcceptFromSelf,			METH_VARARGS},
		 { VMProtectDecryptStringA("GetAcceptFromTarget"),			exchangeGetAcceptFromTarget,		METH_VARARGS},

		 { VMProtectDecryptStringA("GetNameFromSelf"),				exchangeGetNameFromSelf,			METH_VARARGS},
		 { VMProtectDecryptStringA("GetNameFromTarget"),			exchangeGetNameFromTarget,			METH_VARARGS},

#ifdef ENABLE_LEVEL_IN_TRADE
		 { VMProtectDecryptStringA("GetLevelFromSelf"),			exchangeGetLevelFromSelf,			METH_VARARGS},
		 { VMProtectDecryptStringA("GetLevelFromTarget"),			exchangeGetLevelFromTarget,			METH_VARARGS},
#endif

		 { VMProtectDecryptStringA("GetItemMetinSocketFromTarget"),	exchangeGetItemMetinSocketFromTarget,	METH_VARARGS},
		 { VMProtectDecryptStringA("GetItemMetinSocketFromSelf"),		exchangeGetItemMetinSocketFromSelf,		METH_VARARGS},

		 { VMProtectDecryptStringA("GetItemAttributeFromTarget"),	exchangeGetItemAttributeFromTarget,	METH_VARARGS},
		 { VMProtectDecryptStringA("GetItemAttributeFromSelf"),	exchangeGetItemAttributeFromSelf,	METH_VARARGS},

		 { VMProtectDecryptStringA("GetElkMode"),					exchangeGetElkMode,					METH_VARARGS},
		 { VMProtectDecryptStringA("SetElkMode"),					exchangeSetElkMode,					METH_VARARGS},

		{NULL, NULL},
	};

	PyObject* poModule = Py_InitModule(VMProtectDecryptStringA("exchange"), s_methods);
	PyModule_AddIntConstant(poModule, VMProtectDecryptStringA("EXCHANGE_ITEM_MAX_NUM"), CPythonExchange::EXCHANGE_ITEM_MAX_NUM);
	VMProtectEnd();
}
