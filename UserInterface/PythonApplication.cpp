...
bool LoadLocaleData(const char* localePath)
{
	...
	_snprintf(szItemList,	sizeof(szItemList) ,	"arezzo/item_list.txt");
#else
	_snprintf(szItemList,	sizeof(szItemList) ,	"%s/item_list.txt",	localePath);
#endif
	_snprintf(szItemProto,	sizeof(szItemProto),	"arezzo/item_proto");
	_snprintf(szItemDesc,	sizeof(szItemDesc),	"arezzo/itemdesc.txt");
	_snprintf(szMobProto,	sizeof(szMobProto),	"arezzo/mob_proto");
	_snprintf(szSkillDescFileName, sizeof(szSkillDescFileName),	"arezzo/skilldesc.txt");
	#ifdef ENABLE_LOCALE_EX
	_snprintf(szSkillTableFileName, sizeof(szSkillTableFileName),	"locale/ex/SkillTable.txt");
	#else
	_snprintf(szSkillTableFileName, sizeof(szSkillTableFileName),	"arezzo/skilltable.txt");
	#endif
	_snprintf(szInsultList,	sizeof(szInsultList),	"arezzo/insult.txt");
#ifdef ENABLE_OBJ_SCALLING
	_snprintf(szMobScale, sizeof(szMobScale), "arezzo/mob_scale.txt");
#endif
#ifdef ENABLE_SHINING_SYSTEM
	_snprintf(szShiningTable, sizeof(szShiningTable), "arezzo/shiningtable.txt");
#endif
	rkNPCMgr.Destroy();
	rkItemMgr.Destroy();
	rkSkillMgr.Destroy();
	...
	_snprintf(szChestDrop, sizeof(szChestDrop), "arezzo/chest_drop");
	...
	#ifdef ENABLE_LOCALE_EX
	_snprintf(szItemScale, sizeof(szItemScale), "locale/ex/item_scale.txt");
	#else
	_snprintf(szItemScale, sizeof(szItemScale), "%s/item_scale.txt", localePath);
	#endif
