...
void initsnd()
{
	VMProtectBeginUltra("initsnd");
	static PyMethodDef s_methods[] =
	{
		{ VMProtectDecryptStringA("PlaySound"),				sndPlaySound,				METH_VARARGS },
		{ VMProtectDecryptStringA("PlaySound3D"),			sndPlaySound3D,				METH_VARARGS },
		{ VMProtectDecryptStringA("PlayMusic"),				sndPlayMusic,				METH_VARARGS },
		{ VMProtectDecryptStringA("FadeInMusic"),			sndFadeInMusic,				METH_VARARGS },
		{ VMProtectDecryptStringA("FadeOutMusic"),			sndFadeOutMusic,			METH_VARARGS },
		{ VMProtectDecryptStringA("FadeOutAllMusic"),		sndFadeOutAllMusic,			METH_VARARGS },
		{ VMProtectDecryptStringA("FadeLimitOutMusic"),		sndFadeLimitOutMusic,		METH_VARARGS },
		{ VMProtectDecryptStringA("StopAllSound"),			sndStopAllSound,			METH_VARARGS },

		{ VMProtectDecryptStringA("SetMusicVolumef"),		sndSetMusicVolume,			METH_VARARGS },
		{ VMProtectDecryptStringA("SetMusicVolume"),			sndSetMusicVolume,			METH_VARARGS },
		{ VMProtectDecryptStringA("SetSoundVolumef"),		sndSetSoundVolumef,			METH_VARARGS },
		{ VMProtectDecryptStringA("SetSoundVolume"),			sndSetSoundVolume,			METH_VARARGS },
		{ VMProtectDecryptStringA("SetSoundScale"),			sndSetSoundScale,			METH_VARARGS },
		{ VMProtectDecryptStringA("SetAmbienceSoundScale"),	sndSetAmbienceSoundScale,	METH_VARARGS },
		{ NULL,						NULL,						NULL },
	};
	Py_InitModule(VMProtectDecryptStringA("snd"), s_methods);
	VMProtectEnd();
