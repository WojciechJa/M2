...
PyObject * appSetDefaultFontName(PyObject * poSelf, PyObject * poArgs)
{
	...
	bool flag = false;
	PyTuple_GetBoolean(poArgs, 1, &flag);
	DefaultFont_SetName(szFontName, flag);
#else
	// DEFAULT_FONT
...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LRN_BATTLE_PASS",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LRN_BATTLE_PASS",	0);
#endif
#ifdef ENABLE_ODLAMKI_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ODLAMKI_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ODLAMKI_SYSTEM", 0);
#endif
#ifdef USE_FISH_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_USE_FISH_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_USE_FISH_SYSTEM", 0);
#endif
#ifdef ENABLE_COLLECTIONS_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_COLLECTIONS_SYSTEM", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COLLECTIONS_SYSTEM", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LRN_LOCATION_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LRN_LOCATION_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_VS_SHOP_SEARCH", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VS_SHOP_SEARCH", 0);
#endif

#ifdef ENABLE_VS_COSTUME_BONUSES
	PyModule_AddIntConstant(poModule, "ENABLE_VS_COSTUME_BONUSES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VS_COSTUME_BONUSES", 0);
#endif
...
#if defined(ENABLE_NEW_STONE_DETACH)
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_STONE_DETACH", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_STONE_DETACH", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PERFORMANCE_IMPROVEMENTS_NEW", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PERFORMANCE_IMPROVEMENTS_NEW", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_INFO_PCT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_INFO_PCT", 0);
#endif
...
#ifdef ENABLE_DYNAMIC_FONTS
	PyModule_AddIntConstant(poModule, "ENABLE_DYNAMIC_FONTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DYNAMIC_FONTS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ARTEFAKT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ARTEFAKT_SYSTEM", 0);
#endif
#ifdef ENABLE_MINIMAP_DUNGEONINFO
	PyModule_AddIntConstant(poModule, "ENABLE_MINIMAP_DUNGEONINFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MINIMAP_DUNGEONINFO", 0);
#endif
#ifdef RENEWAL_RENDERING_RECT_BOX
	PyModule_AddIntConstant(poModule, "RENEWAL_RENDERING_RECT_BOX", 1);
#else
	PyModule_AddIntConstant(poModule, "RENEWAL_RENDERING_RECT_BOX", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PUNKTY_OSIAGNIEC", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PUNKTY_OSIAGNIEC", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILE_PASYWNE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILE_PASYWNE", 0);
#endif
#if defined(ENABLE_INSTANT_CHEST_OPEN)
	PyModule_AddIntConstant(poModule, "ENABLE_INSTANT_CHEST_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INSTANT_CHEST_OPEN", 0);
#endif
#ifdef ENABLE_EXTRABONUS_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRABONUS_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRABONUS_SYSTEM", 0);
#endif

#ifdef ENABLE_SYSTEM_RUNE
	PyModule_AddIntConstant(poModule, "ENABLE_SYSTEM_RUNE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SYSTEM_RUNE", 0);
#endif

#if defined(ENABLE_INSTANT_INGOT_OPEN)
	PyModule_AddIntConstant(poModule, "ENABLE_INSTANT_INGOT_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INSTANT_INGOT_OPEN", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_SYSTEM", 0);
#endif

#ifdef CHECK_CLIENT_VERSION
	PyModule_AddIntConstant(poModule, "CHECK_CLIENT_VERSION", 1);
#else
	PyModule_AddIntConstant(poModule, "CHECK_CLIENT_VERSION", 0);
#endif

#ifdef TAKE_LEGEND_DAMAGE_BOARD_SYSTEM
	PyModule_AddIntConstant(poModule, "TAKE_LEGEND_DAMAGE_BOARD_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "TAKE_LEGEND_DAMAGE_BOARD_SYSTEM", 0);
#endif

#ifdef FAST_ITEMS_PICKUP
	PyModule_AddIntConstant(poModule, "FAST_ITEMS_PICKUP", 1);
#else
	PyModule_AddIntConstant(poModule, "FAST_ITEMS_PICKUP", 0);
#endif

#ifdef __ENABLE_TOGGLE_ITEMS__
	PyModule_AddIntConstant(poModule, "__ENABLE_TOGGLE_ITEMS__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_TOGGLE_ITEMS__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_PRIVATE_SHOP_OFFICIAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_PRIVATE_SHOP_OFFICIAL", 0);
#endif
