...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_title_active = src.m_title_active;
#endif
}
...
{
	Lognf(0, VMProtectDecryptStringA("CNetworkActorManager::__AppendCharacterManagerActor(%d, %s)"), rkNetActorData.m_dwVID, rkNetActorData.m_stName.c_str());
...
#endif
#ifdef TITLE_SYSTEM_BYLUZER
	kCreateData.m_title_active = rkNetActorData.m_title_active;
#endif
...
#endif
#ifdef ENABLE_COSTUME_EMBLEMAT
	kCreateData.m_dwEmblemat = rkNetActorData.m_dwEmblemat;
#endif
#ifdef ENABLE_AURA_SYSTEM
...
#endif
#ifdef ENABLE_COSTUME_EMBLEMAT
		pkInstFind->ChangeEmblemat(c_rkNetUpdateActorData.m_dwEmblemat);
#endif
...
#ifdef TITLE_SYSTEM_BYLUZER
 		pkInstFind->SetGradeID(c_rkNetUpdateActorData.m_title_active);
#endif
...
#ifdef TITLE_SYSTEM_BYLUZER
	rkNetActorData.m_title_active = c_rkNetUpdateActorData.m_title_active;
#endif
...
#endif
#ifdef ENABLE_COSTUME_EMBLEMAT
	rkNetActorData.m_dwEmblemat = c_rkNetUpdateActorData.m_dwEmblemat;
#endif
