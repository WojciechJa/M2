...
#endif
	TraceError(" RecvLoginFailurePacket : [%s]\n", packet_failure.szStatus);
	return true;
}
...
void CPythonNetworkStream::AllowLogin()
{
	PyCallClassMemberFunc(m_apoPhaseWnd[PHASE_WINDOW_LOGIN], "AllowLogin", Py_BuildValue("()"));
}
#endif
