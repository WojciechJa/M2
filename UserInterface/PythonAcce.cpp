...
void CPythonAcce::AddMaterial(long long dwRefPrice, long long dwRefPrice2, BYTE chance, BYTE bPos, TItemPos tPos)
{
...
void CPythonAcce::RemoveMaterial(long long dwRefPrice, long long dwRefPrice2, BYTE chance, BYTE bPos)
{
	if (bPos >= ACCE_WINDOW_MAX_MATERIALS)
		return;
...
PyObject* GetAcceCheque(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("L", CPythonAcce::Instance().GetCheque());
}

PyObject* GetAcceChance(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonAcce::Instance().GetChance());
}
...
void initAcce()
{
	static PyMethodDef functions[] = {
		...
		{"GetCheque",				GetAcceCheque,				METH_VARARGS},
		{"GetChance",				GetAcceChance,				METH_VARARGS},
