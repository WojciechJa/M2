...
PyObject* dungeonInfoGetBossDropItemPercentage(PyObject* poSelf, PyObject* poArgs)
{
	BYTE byIndex;
	if (!PyTuple_GetByte(poArgs, 0, &byIndex))
		return Py_BuildException();
	...
	return Py_BuildValue("f", CPythonDungeonInfo::Instance().GetBossDropItemPercentage(byIndex, bySlot));
}
...
void initDungeonInfo()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetBossDropItemPercentage", dungeonInfoGetBossDropItemPercentage, METH_VARARGS },
