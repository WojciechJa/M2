...
class CInstanceBase
{
	...
	public:
		...
		enum
		{
			...
			NEW_AFFECT_PREMIUM_PRIVATE_SHOP = 508,
#endif
			...
			NEW_AFFECT_SKILE_PAS_BOOK_BONUS = 519,
			NEW_AFFECT_SKILE_PAS_NO_BOOK_DELAY = 520,

			NEW_AFFECT_SKILE_PET_BOOK_BONUS = 521,
			NEW_AFFECT_SKILE_PET_NO_BOOK_DELAY = 522,

			NEW_AFFECT_SKILE_BUFF_BOOK_BONUS = 523,
			NEW_AFFECT_SKILE_BUFF_NO_BOOK_DELAY = 524,
...
#endif
#ifdef ENABLE_SYSTEM_RUNE
			EFFECT_RUNA_WHITE_EQUIP,
			EFFECT_RUNA_RED_EQUIP,
			EFFECT_RUNA_BLUE_EQUIP,
			EFFECT_RUNA_YELLOW_EQUIP,
			EFFECT_RUNA_BLACK_EQUIP,
			EFFECT_RUNA_GREEN_EQUIP,
#endif
#ifdef ENABLE_EFFECT_DAMAGE_FIRE
			EFFECT_DAMAGE_FIRE,
#endif
...
#ifdef TITLE_SYSTEM_BYLUZER
		void					UpdateTextTailGrade(BYTE grade);
#endif
...
#ifdef ENABLE_COSTUME_EMBLEMAT
		bool					SetEmblemat(DWORD eEmblemat);
		void					ChangeEmblemat(DWORD eEmblemat);
#endif
...
#endif
#ifdef ENABLE_COSTUME_EMBLEMAT
		void	__ClearEmblematRefineEffect();
#endif
	protected:
