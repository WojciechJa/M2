...
void CPythonSystem::SetDefaultConfig()
{
	...
	m_Config.bShowSalesText		= false;
#ifdef ENABLE_DOG_MODE
	m_Config.bDogMode = false;
#endif
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM
	m_Config.bShowAutoBuff = false;
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
	m_Config.bShowPet = false;
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
	m_Config.bShowMount = false;
#endif
#ifdef ENABLE_OFFLINE_SHOP_SYSTEM
	m_Config.fOfflineShopRange = 5000.0f;
#endif
...
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM
void CPythonSystem::SetShowAutoBuffMode(int iFlag)
{
	m_Config.bShowAutoBuff = iFlag == 1 ? true : false;

	CPythonCharacterManager& rkChrMgr = CPythonCharacterManager::Instance();
	//rkChrMgr.SetDogMode(m_Config.bShowAutoBuff);
}

bool CPythonSystem::GetShowAutoBuffMode()
{
	return m_Config.bShowAutoBuff;
}
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
void CPythonSystem::SetShowPetMode(int iFlag)
{
	m_Config.bShowPet = iFlag == 1 ? true : false;

	CPythonCharacterManager& rkChrMgr = CPythonCharacterManager::Instance();
	//rkChrMgr.SetDogMode(m_Config.bShowPet);
}

bool CPythonSystem::GetShowPetMode()
{
	return m_Config.bShowPet;
}
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
void CPythonSystem::SetShowMountMode(int iFlag)
{
	m_Config.bShowMount = iFlag == 1 ? true : false;

	CPythonCharacterManager& rkChrMgr = CPythonCharacterManager::Instance();
	//rkChrMgr.SetDogMode(m_Config.bShowMount);
}

bool CPythonSystem::GetShowMountMode()
{
	return m_Config.bShowMount;
}
#endif
#ifdef ENABLE_OFFLINE_SHOP_SYSTEM
float CPythonSystem::GetShowOfflineShopRange()
{
	return m_Config.fOfflineShopRange;
}

void CPythonSystem::SetShowOfflineShopRange(float fFlag)
{
	m_Config.fOfflineShopRange = fMINMAX(1.f, fFlag, 5000.0f);
}
#endif
...
#endif
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM
		else if (!stricmp(command, "SHOW_AUTO_BUFF_ON"))
			m_Config.bShowAutoBuff = atoi(value) == 1 ? true : false;
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
		else if (!stricmp(command, "SHOW_PET_ON"))
			m_Config.bShowPet = atoi(value) == 1 ? true : false;
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
		else if (!stricmp(command, "SHOW_MOUNT_ON"))
			m_Config.bShowMount = atoi(value) == 1 ? true : false;
#endif
#ifdef ENABLE_OFFLINE_SHOP_SYSTEM
		else if (!stricmp(command, "OFFLINE_SHOP_RANGE"))
			m_Config.fOfflineShopRange = atof(value);
#endif
#ifdef ENABLE_PREMIUM_PRIVATE_SHOP_OFFICIAL
...
#endif
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM
	fprintf(fp, "SHOW_AUTO_BUFF_ON			%d\n", m_Config.bShowAutoBuff);
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
	fprintf(fp, "SHOW_PET_ON			%d\n", m_Config.bShowPet);
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
	fprintf(fp, "SHOW_MOUNT_ON			%d\n", m_Config.bShowMount);
#endif
#ifdef ENABLE_OFFLINE_SHOP_SYSTEM
	fprintf(fp, "OFFLINE_SHOP_RANGE					%.2f\n", m_Config.fOfflineShopRange);
#endif
