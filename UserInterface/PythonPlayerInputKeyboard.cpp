...
void CPythonPlayer::OnKeyDown(int iKey)
{
	...
	if (it != m_keySettingMap.end())
	{
		...
		case KEY_TP_MAP:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_TP_MAP, ""));
			break;
		...
		case KEY_OPEN_EXTENDED_INV:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_EXTENDED_INV, ""));
			break;
		...
		case KEY_OPEN_DOPY:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_DOPY, ""));
			break;
		
		case KEY_OPEN_MARBLE:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_MARBLE, ""));
			break;
		
		case KEY_OPEN_SAVE_LOCATION:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_SAVE_LOCATION, ""));
			break;
		
		case KEY_OPEN_RESP:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_RESP, ""));
			break;
		
		case KEY_OPEN_BUFF:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_BUFF, ""));
			break;
		
		case KEY_OPEN_MISSION:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_MISSION, ""));
			break;

		case KEY_OPEN_COLLECTION:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_COLLECTION, ""));
			break;
		
		case KEY_RETURN:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_RETURN, ""));
			break;

		case KEY_OPEN_DUNGEONS:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_OPEN_DUNGEONS, ""));
			break;

		case KEY_CHANGECHANNEL1:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL1, ""));
			break;
		case KEY_CHANGECHANNEL2:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL2, ""));
			break;
		case KEY_CHANGECHANNEL3:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL3, ""));
			break;
		case KEY_CHANGECHANNEL4:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL4, ""));
			break;
		case KEY_CHANGECHANNEL5:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL5, ""));
			break;
		case KEY_CHANGECHANNEL6:
			PyCallClassMemberFunc(m_ppyGameWindow, "OpenWindow", Py_BuildValue("(is)", KEY_CHANGECHANNEL6, ""));
			break;
