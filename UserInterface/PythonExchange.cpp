...
void CPythonExchange::SetChequeToTarget(long long cheque)
{
	m_victim.cheque = cheque;
}

void CPythonExchange::SetChequeToSelf(long long cheque)
{
	m_self.cheque = cheque;
}

long long CPythonExchange::GetChequeFromTarget()
{
	return m_victim.cheque;
}

long long CPythonExchange::GetChequeFromSelf()
{
...
void CPythonExchange::SetItemToTarget(DWORD pos, DWORD vnum, int count)
#else
...
#ifdef ENABLE_EXTENDED_ITEM_COUNT
void CPythonExchange::SetItemToSelf(DWORD pos, DWORD vnum, int count)
#else
...
#ifdef ENABLE_EXTENDED_ITEM_COUNT
int CPythonExchange::GetItemCountFromTarget(BYTE pos)
#else
...
#ifdef ENABLE_EXTENDED_ITEM_COUNT
int CPythonExchange::GetItemCountFromSelf(BYTE pos)
#else
