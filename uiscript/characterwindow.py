			...
			[
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":-3, "text":uiScriptLocale.CHARACTER_SKILL, "all_align":"center", "outline":"1", },
					),
				},
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":-3, "text":uiScriptLocale.CHARACTER_ACTION, "all_align":"center", "outline":"1", },
					),
				},
				{
					"name" : "Quest_TitleBar",
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":-3, "text":uiScriptLocale.CHARACTER_QUEST, "all_align":"center", "outline":"1", },
					),
				},
				...
				## Page Area
				{
					...
					[
						...
						## Title Area
						{
							...
							"children" :
							(
								{ "name" : "TitleName", "type":"text", "x":0, "y":-3, "text":uiScriptLocale.CHARACTER_MAIN, "all_align":"center", "outline":"1", },
							),
						},
