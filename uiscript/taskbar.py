...
window = {
	...
	(
		...
		# 	"tooltip_text_new" : uiScriptLocale.TASKBAR_IS_DEPO,
		# 	"tooltip_text_color" : 0xfff1e6c0,
		# 	"tooltip_x" : 0,
		# 	"tooltip_y" : -35,
		...
		## Button
		{
			...
			"default_image" : ROOT + "TaskBar/shop_01.sub",
			"over_image" : ROOT + "TaskBar/shop_02.sub",
			"down_image" : ROOT + "TaskBar/shop_03.sub",
		},
