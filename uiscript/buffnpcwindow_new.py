					...
					(
						{
							...
							"children":
							(
								{ "name" : "b0ard3", "type" : "image", "x" : 1, "y" : 1, "image" : IMG_PATH + "board3.png"},
								{
									"name":"header",
									"type":"image",
									"x" : 0,
									"y" : 128,
									"image":IMG_PATH+"header_small.png",
									"children":
									(
										{
											"name":"int_points",
								...
								{ 
									"name" : "eq_board", "type" : "image", "x" : 30, "y" : 16, "image" : IMG_PATH + "equipment.png",
									"children" :
									(
										{
						...
						},
						{
							...
							"children":
							(
								{ "name" : "b0ard", "type" : "image", "x" : 1, "y" : 1, "image" : IMG_PATH + "board.png"},
